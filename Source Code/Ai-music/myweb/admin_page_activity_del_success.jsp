...
<%
	...
	int id = Integer.parseInt(request.getParameter("id")); //接受上一頁傳來的id值 (id值 = activity_code值)
	...
	sql = "DELETE FROM activity_info WHERE activity_code = '" + id + "'"; //[WHERE activity_code=?] 重要!!! 記得要加!
...
<div  id="bigright" class="font10 style4 right roundedCorners" align="left">
  ...
  <div class="space">
    ...
    <div class="table-padding">
     <span class="table-padding style11">活動刪除成功,3秒後為您轉回活動管理頁面。</span>
    </div>
