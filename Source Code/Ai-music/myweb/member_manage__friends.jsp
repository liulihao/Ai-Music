...
<div id="showid" class="font10 style4" align="left"><a href="member_page.jsp?user=<%=login_user%>">首頁</a>
  <!-- end of 會員標頭-->
  <span class="style12">&gt;&nbsp;</span><a href="member_manage.jsp">我的管理中心</a> <span class="style12">&gt;&nbsp;</span><a href="member_manage_friends.jsp">好友管理</a></div>
  ...
  <div id="TabbedPanels1" class="TabbedPanels">
    ...
    <div class="TabbedPanelsContentGroup">
      <div class="TabbedPanelsContent">
        <!--別人希望加妳為好友的訊息-->
        <div class="font10"><font color="#FF0000">若要接受對方的好友申請，請按確定</font></div>
	...
	ResultSet friend_added_data = friend_added.executeQuery(friend_added_sql);
     while(friend_added_data.next()){
		//String friend_added_friend_id = friend_added_data.getString("friend.friend_id");//從friend抓friend_id
...
%>
          <div class="friend-block" align="center">
            <input type="button" class="new-block style4" value="確認" onclick="location.href='member_manage_friends_accept.jsp?user_id=<%=login_user%>&friend_id=<%=friend_added_user_id%>'"/>
            <img src="user/<%=friend_added_user_id%>/<%=friend_added_user_pic%>" width="90" height="90" /><br />
            <a href="member_page.jsp?user=<%=friend_added_user_id%>"><%=friend_added_user_nkname%></a> </div>
          <%
		 	}//beFriend_data
        ...
        <!--end of padding2-->
        <div class="font10"><font color="#FF0000">還在等待對方同意你的好友申請</font></div>
        <div class="table-padding">
          <!--padding3-->
          <%	 
...
%>
          <div class="friend-block" align="center"> <font color=blue>等待同意中</font> <img src="user/<%=friend_add_user_id%>/<%=friend_add_user_pic%>" width="90" height="90" /><br />
            <a href="member_page.jsp?user=<%=friend_add_user_id%>"><%=friend_add_user_nkname%></a> </div>
          <%
		 	}//beFriend_data
...
%>
		  ...
		  %>
          <div class="friend-block" align="center">
            <input type="button" class="delete-block2 style4" value="刪除1" onclick="location.href='member_manage_friends_delete.jsp?user_id=<%=user_id%>&friend_id=<%=friend_id%>'"/>
            <div style="border:1px solid #E5E5E5"><img src="user/<%=friend_id%>/<%=friend_pic%>" width="90" height="90" /></div><br />
            <a href="member_page.jsp?user=<%=friend_id%>"><%=friend_nkname%></a> </div>
          <%
		  		} //if end
		   	i++;
		  	}//rs
