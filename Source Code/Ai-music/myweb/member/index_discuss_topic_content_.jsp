...
%>
       <tr>
          ...
          <div style="margin:10px 0px" align="center">
           <div style="border:1px solid #E5E5E5; width:90px"><img src='../user/<%=user_id%>/<%=user_pic%>' alt="" width="90" height="90" /></div>
...
%>
		 <tr>
             ...
             <div style="margin:10px 0px" align="center">
            <a href="../member_page.jsp?user=<%=user_id%>"><div style="border:1px solid #E5E5E5;width:90px"><img src='../user/<%=user_id%>/<%=user_pic%>' alt="" width="90" height="90" /></div>
            </a><a href="../member_page.jsp?user=<%=user_id%>"></a>
            <table width="100%" border="0" cellspacing="3">
  <tr>
    <td><div align="center"><a href="../member_page.jsp?user=<%=user_id%>"><%=user_nkname%></a></div></td>
    </tr>
    <tr>
    <td><div align="center" class="style14"><%=reply_time%></div></td>
    </tr>
</table>
</div>            </td>
         ...
         <tr>
       	   <td width="635" height="10" style="border-left:1px dashed #5C5C5C;">&nbsp;</td>
           <%
		   if(find_user_id_reply.equals(login_user)){//if find_user_id_reply%>
			...
			<td width="46" style="border-bottom:1px; border-left:1px dashed #5F5F5F;">
            <input type="submit" name="send" value="刪除" style="border:1px solid #FFFFFF; background:#FFFFFF; color:#5F5F5F " class="pointer"></td>
			<input type = "hidden" name = "title_id" value=<%=title_id%>>
			<input type = "hidden" name = "reply_id" value=<%=reply_id%>>
			</form>
            <%}else{%>
   	       <td width="44" height="10" style="border-left:1px dashed #5C5C5C;">&nbsp;&nbsp;#<%=num%></td><%}}//while find_user_data_reply end%>
   		 </tr>
    </table>
  </div>
...
<script type="text/javascript">
  ...
  function discuss_reply() {
    Dialog.confirm("1",{className: "alphacube", width:500 ,height:343,closable:true,url: "replytitle.jsp?title_id=<%=title_id%>"})
  }
