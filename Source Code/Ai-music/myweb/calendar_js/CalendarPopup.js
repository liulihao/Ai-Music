...
var MONTH_NAMES=new Array('January','February','March','April','May','June','July','August','九月','October','November','December','Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec');
...
function CP_getCalendar() {
	...
	if (this.displayType=="date" || this.displayType=="week-end") {
		...
		if (this.isShowNavigationDropdowns) {
			...
			//for( var yearCounter=year-this.yearSelectStartOffset; yearCounter<=year; yearCounter++ ) //原來的設定
			for( var yearCounter=1930; yearCounter<=2009; yearCounter++ ) {
